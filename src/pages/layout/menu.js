...
class Component extends PureComponent {
  ...
  Logo = () => <Image size="mini" src={logo} style={{ marginRight: "1.5em" }} />

  MenuLogo = () => <Menu.Item header as={Link} to="/">
                      <this.Logo /> GFOX
                  </Menu.Item>
      ...
      <Dropdown.Menu style={this.style}>
        ...
        <Dropdown.Item> <i className="dropdown icon" />{" "} <span className="text">Ön Tanımlar</span>
          <Dropdown.Menu style={this.style}>
            ...
            <Dropdown.Item as={Link} to='/kv_kategoriler'> <TanimlarIcon /> KV Kategorileri</Dropdown.Item>
            ...
            <Dropdown.Item as={Link} to='/isleme_amaclari'> <TanimlarIcon /> İşleme Amaçları </Dropdown.Item>
            ...
            <Dropdown.Item as={Link} to='/paylasim_amaclari'> <TanimlarIcon /> Paylaşım Amaçları</Dropdown.Item>
            <Dropdown.Item as={Link} to='/paylasim_sekilleri'> <TanimlarIcon /> Paylaşım Şekilleri</Dropdown.Item>
  ...
  MenuTalepler = () => <Menu.Item header as={Link} to='/talepler'>
    <Icon name="mail" color={this.state.color.icon} size="large" />Talepler
</Menu.Item>
  ...
  MenuSorgula = () => {
    ...
    return <Menu.Item header as={Link} to="#" onClick={handleSearchMode} >
      {this.props.searchMode ?
        <Icon name="search minus" size="large" color={this.state.color.icon} inverted />
        : <Icon name="search" size="large" color={this.state.color.icon} />} Sorgula
      </Menu.Item>
  }


  MenuAnaliz = () => <Menu.Item header as={Link} to='/analiz'>
...
MenuCID = () => {
  ...
  return <Menu.Item header position='right' >
...
MenuExit = () => {
  ...
  return <Menu.Item header as={Link} to="/logout" onClick={handleExit}>
