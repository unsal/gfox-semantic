...
class Anaveriler extends PureComponent {
  state = {
    ...
    deleteMode: false,
    editMode: false,
    fields: ['profil_pidm', 'surec_pidm', 'kv_pidm', 'isleme_amaclari_data', 'dayanaklar_data',
                    'kanallar_data','sure_pidm', 'tedbirler_data', 'sistemler_data', 'ortamlar_data'],
...
//id-> selected data id (ortamlar, tedbirler), anaveri pidm->silmek için, data
  ...
  ViewRow = ({ row }) => {
    ...
    return <Table.Row >
      ...
      <Table.Cell style={this.styleView}><DataTitles row={row} color='blue' data={row.isleme_amaclari_data} /></Table.Cell>
      <Table.Cell style={this.styleView}><DataTitles row={row} color='teal' data={row.dayanaklar_data} /></Table.Cell>
      <Table.Cell style={this.styleView}><DataTitles row={row} color='green' data={row.kanallar_data} /></Table.Cell>
      <Table.Cell style={this.styleView}><DataTitle row={row}>{row.sure_name}</DataTitle></Table.Cell>
      <Table.Cell style={this.styleView}><DataTitles row={row} color='olive' data={row.tedbirler_data} /></Table.Cell>
      <Table.Cell style={this.styleView}><DataTitles row={row} color='yellow' data={row.sistemler_data} /></Table.Cell>
      <Table.Cell style={this.styleView}><DataTitles row={row} color='orange' data={row.ortamlar_data} /></Table.Cell>
    </Table.Row>
